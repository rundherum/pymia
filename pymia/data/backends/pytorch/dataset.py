...
class PymiaTorchDataset(extr.ParameterizableDataset, torch_data.Dataset):
    def __init__(self, dataset_path: str, indexing_strategy: extr.IndexingStrategy=None, extractor: extr.Extractor=None,
        ...
        # changed much
        extr.ParameterizableDataset.__init__(self, dataset_path, indexing_strategy, extractor, transform,
